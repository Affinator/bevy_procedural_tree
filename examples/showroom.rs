...
use bevy_procedural_tree::settings::GlobalTreeMeshSettings;
...
fn main() {
    ...
    #[cfg(feature = "inspector")]
    {
        ...
        app.add_plugins(EguiPlugin::default())
            ...
            .add_plugins(ResourceInspectorPlugin::<GlobalTreeMeshSettings>::default());
    }
...
fn setup(
    ...
    let bark_material = Some(MeshMaterial3d(materials.add(StandardMaterial {
    ...
    let leaf_material = Some(MeshMaterial3d(materials.add(StandardMaterial {
